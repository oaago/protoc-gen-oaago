...
const (
	...
	validatorPkg       = protogen.GoImportPath("github.com/go-playground/validator/v10")
	...
	translatorPkg      = protogen.GoImportPath("github.com/oaago/server/oaa/translator")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by https://github.com/oaago/protoc-gen-oaago. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the https://github.com/oaago/protoc-gen-oaago package it is being compiled against.")
	g.P("// ", contextPkg.Ident(""), metadataPkg.Ident(""))
	g.P("//", ginPkg.Ident(""), errPkg.Ident(""))
	g.P("//", clientv3Pkg.Ident(""), resolverPkg.Ident(""))
	g.P("//", grpcPkg.Ident(""), logxPkg.Ident(""))
	g.P("//", translatorPkg.Ident(""))
	validatorPkg.Ident("validator")
	g.P("//", validatorPkg.Ident(""))
