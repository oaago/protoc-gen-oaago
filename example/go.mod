module github.com/oaago/protoc-gen-oaago/example
...
require (
	...
	github.com/oaago/go-proto-validators v0.3.4
	github.com/oaago/server v0.0.2
...
require (
	...
	github.com/golang-module/carbon v1.6.8 // indirect
