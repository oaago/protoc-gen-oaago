...
var _regex_CccDddRequest_Name = regexp.MustCompile(`^[a-z]{2,5}$`)
...
func (this *CccDddRequest) Validate() error {
	...
	if !(this.Age < 10) {
		return github_com_mwitkow_go_proto_validators.FieldError("Age", fmt.Errorf(`value '%v' must be less than '10'`, this.Age))
	}
	return nil
}

var _regex_CccDddReply_Message = regexp.MustCompile(`^[a-z]{2,5}$`)
